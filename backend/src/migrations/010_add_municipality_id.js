...
export async function up(client) {
  ...
  await client.query(`UPDATE app_units SET municipality_id = '3534401' WHERE municipality_id = ''`);
  ...
  await client.query(`UPDATE app_patients SET municipality_id = '3534401' WHERE municipality_id = ''`);
  ...
  await client.query(`UPDATE app_users SET municipality_id = '3534401' WHERE municipality_id = ''`);
  ...
  await client.query(`UPDATE app_audit_logs SET municipality_id = '3534401' WHERE municipality_id = ''`);
}
