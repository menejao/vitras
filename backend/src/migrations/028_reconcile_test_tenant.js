...
export async function up(client) {
  ...
  await client.query(`
    INSERT INTO app_units (id, name, cnes, municipality_id, municipality_name, uf, status, contact_email, phone, created_at, updated_at)
    VALUES ('test-unit', 'UBS Teste VITRAS', '0000000', '3534401', 'Ambiente de Teste', 'SP', 'test', NULL, NULL, NOW(), NOW())
